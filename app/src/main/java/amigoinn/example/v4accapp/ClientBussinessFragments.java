 ...
 */
public class ClientBussinessFragments extends BaseFragment implements SwipyRefreshLayout.OnRefreshListener {
    ListView listView2;
...
//                ;
    ...
    public void onRefresh(SwipyRefreshLayoutDirection direction) {
        if (NetworkConnectivity.isConnected()) {
            ...
            ClientOrderList.Instance().ClearDbById(c_codee);
            ClientOrderList.Instance().ClearDetailDbById(c_codee);
            loadData();
        } else {
