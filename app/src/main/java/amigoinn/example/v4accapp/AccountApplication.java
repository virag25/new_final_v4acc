...
public class AccountApplication extends Application {
    ...
    public void onCreate() {
        ...
        builder.addClass(ClientOrderInfo.class);
        builder.addClass(ClientDispatchInfo.class);
        builder.addClass(ClientSaleInfo.class);
        builder.addClass(ClientDispatchDetailInfo.class);
        builder.addClass(ClientOrderSaleDetailInfo.class);
        builder.addClass(ClientOrderDetailInfo.class);
