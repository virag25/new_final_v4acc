...
public class ClientOrderDispatchActiviy extends BaseActivity {
    ...
    public void loadData() {
        showProgress();
        ClientDispatchList.Instance().DoClientDispatchDetail(new ModelDelegates.ModelDelegate<ClientDispatchDetailInfo>() {
            @Override
            public void ModelLoaded(ArrayList<ClientDispatchDetailInfo> list) {
                hideProgress();
    ...
    public class ListViewCustomAdapter extends BaseAdapter {
        ...
        ArrayList<ClientDispatchDetailInfo> m_list;

        public ListViewCustomAdapter(Activity context, ArrayList<ClientDispatchDetailInfo> list)
        ...
        public View getView(int arg0, View arg1, ViewGroup arg2) {
            ...
            ClientDispatchDetailInfo info = m_list.get(arg0);
            if (info != null) {
