...
public class ClientLedgersFragment extends BaseFragment implements SwipyRefreshLayout.OnRefreshListener {
    ListView listView2;
    ...
    public void onRefresh(SwipyRefreshLayoutDirection direction) {
        {
            if (NetworkConnectivity.isConnected()) {
                ...
                ClientDispatchList.Instance().ClearDbById(c_codee);
                ClientDispatchList.Instance().ClearDetailDbById(c_codee);
                loadData();
            } else {
