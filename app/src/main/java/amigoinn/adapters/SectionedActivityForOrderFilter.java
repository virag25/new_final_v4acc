...
public class SectionedActivityForOrderFilter extends Activity
{
...
//                Config.filterfrom="party";
                ...
                {
                    in = new Intent(SectionedActivityForOrderFilter.this, ProductFilter.class);
                }
...
//                    getActivity().finish();
    ...
    {
        final MyAdapter adapter = new MyAdapter(SectionedActivityForOrderFilter.this, clint_info);
        stickyList.setAdapter(adapter);
