...
public class ProductSectionedActivityForOrderFilter extends Activity
{
...
//                Config.filterfrom="party";
                ...
                {
                    in = new Intent(ProductSectionedActivityForOrderFilter.this, ProductFilter.class);
                }
...
//                    Intent in = new Intent(SectionedActivityForOrderFilter.this, amigoinn.example.v4sales.AbsentList.class);
//                    startActivity(in);
                    finish();
                }
            }
...
//                    getActivity().finish();
    ...
    {
        final MyAdapter adapter = new MyAdapter(ProductSectionedActivityForOrderFilter.this, clint_info);
        stickyList.setAdapter(adapter);
